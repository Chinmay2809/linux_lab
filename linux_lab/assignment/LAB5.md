...
It ensures consistency by creating the same folder structure every time and adding placeholder README.md files in each 
...
# === Base directory ===
BASE_DIR="/home/chinmay2809/ds_starter"
...
It builds the required folder structure, adds placeholder documentation files, and provides a clear starting point for any
...
Answer. ```mkdir -p-- ```creates a directory and its parent directories if they don’t exist, and doesn’t give an error if

the directory already exists.

## Q. Why is automation useful in DevOps?

Answer. 👉 In short: Automation in DevOps = faster delivery + fewer errors + more reliable systems.